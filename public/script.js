(() => {
  ...
  const i18n = {
    en: {
      navDocs: 'Docs',
      navTryIt: 'Try It',
      heroTagline: 'Indonesian public holiday data, available via a simple REST API.<br>Query holidays by date, check today or tomorrow.',
      ...
      featuresHeading: 'Why API Hari Libur?',
      featureDataTitle: 'Data from 2011',
      featureDataDesc: '15+ years of Indonesian public holidays. Comprehensive historical coverage.',
      featureFreeTitle: 'Free & Fast',
      featureFreeDesc: 'No signup, no API key, no rate limits. Just call the endpoint.',
      featureApiTitle: 'Simple JSON API',
      featureApiDesc: 'RESTful endpoints. Clean JSON responses. Easy to integrate.',
    ...
    id: {
      navDocs: 'Dokumentasi',
      navTryIt: 'Coba',
      heroTagline: 'Data hari libur nasional Indonesia, tersedia via REST API sederhana.<br>Query hari libur berdasarkan tanggal, cek hari ini atau besok.',
      ...
      langLabel: 'ID',
      featuresHeading: 'Mengapa API Hari Libur?',
      featureDataTitle: 'Data dari 2011',
      featureDataDesc: '15+ tahun hari libur nasional Indonesia. Cakupan historis lengkap.',
      featureFreeTitle: 'Gratis & Cepat',
      featureFreeDesc: 'Tanpa daftar, tanpa API key, tanpa batas request. Langsung pakai.',
      featureApiTitle: 'API JSON Sederhana',
      featureApiDesc: 'Endpoint RESTful. Response JSON bersih. Mudah diintegrasikan.',
      months: [
